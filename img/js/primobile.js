...
rotate();
    ...
    window.addEventListener('resize', function(){
                  if(window.innerWidth >  window.innerHeight){                                        
                    ...
                    toggle();
                    document.getElementById("thewin").style.float="center";                     
                    document.getElementById("thewin").style.content = 'url("img/win_youPortrait.png")';
                    document.getElementById("end").innerHTML = '<br>  Ruotare il dispositivo<br>  in posizione verticale<br>---<br>Rotate the device';
                    document.getElementById("endwind").style.visibility= "hidden";
                    document.getElementById("endwind2").style.visibility= "hidden";
                    document.getElementById('classifica').textContent = '';
                    document.getElementById('classifica1').textContent = '';
                    document.getElementById('classifica2').textContent = '';
                    document.getElementById('classifica3').textContent = '';
                    document.getElementById('classifica4').textContent = '';                 
...
// lampeggio costante mazzo centrale per click estrazione 
MyBlink2();
...
switch (game) {
  case null : document.getElementById("round").style.content = 'url("img/prima3.png")';
              document.getElementById('estr_win').style.visibility= "hidden";     
             break;
  case '2'  : document.getElementById("round").style.content = 'url("img/seconda3.png")';
              document.getElementById('estr_win').style.visibility= "initial";              
              switch(w) {
                case 0 : win_estr = win_estr + 'Pari/Alto';                                               
                         break;
                case 1 : win_estr = win_estr + 'Pari/Basso';                         
                         break;
                case 2 : win_estr = win_estr + 'Dispari/Alto';                         
                         break;
                case 3 : win_estr = win_estr + 'Dispari/Basso';                         
                         break;
              }                                         
              //document.images["mazzo"].src = maz_win[on].img;
              document.getElementById("estratte").innerHTML = "<br>"+win_estr+"<br>";                  
              //alert(win_estr); 
              console.log(maz_win[on]);    
              document.getElementById("mazzos").style.content = 'url('+maz_win[on].img+')'; 
             break;
  case '3'  : document.getElementById("round").style.content = 'url("img/terza3.png")';
              document.getElementById('estr_win').style.visibility= "initial"; 
              win_estr = maz_win[w].val+', ';
              switch(i) {
                case 0 : win_estr = win_estr + 'Pari/Alto';
                        break;
                case 1 : win_estr = win_estr + 'Pari/Basso';
              ...
              document.getElementById("estratte").innerHTML = "<br>"+win_estr+"<br>";              
             break;
  case '4'  : document.getElementById("round").style.content = 'url("img/quarta3.png")';
              document.getElementById('estr_win').style.visibility= "initial"; 
              win_estr = maz_win[w].val+', '+maz_win[i].val+', ';
              switch(n) {
                case 0 : win_estr = win_estr + 'Pari/Alto';
                        break;
                case 1 : win_estr = win_estr + 'Pari/Basso';
...
if (lx<6) {
   ...
   // in apertura, sempre sullo stesso array, rimandando a dopo la selezione di 4 su 10 che però
   // avvantaggia gli avversari

// per estetica aggiungo il movimento delle card coperte pescate dagli avversari
  

  
var Estraz1 = document.getElementById('Estraz1');
var Estraz3 = document.getElementById('Estraz3');
let start = Date.now();

let timer = setInterval(function() {

    let timePassed = Date.now() - start;
    //Estraz1.style.marginRight = `${-330 + timePassed / 3}px`;
    document.getElementById('retroround').style.visibility= "hidden";    
    document.getElementById('youestraz').style.visibility= "hidden";
    //document.getElementById('estratte').style.visibility= "hidden";
    Estraz1.style.marginRight = `${-100 + timePassed / 5}%`;
    Estraz3.style.marginLeft = `${-100 + timePassed / 5}%`;
                    
  if (timePassed > 500) {  
      Estraz1.style.marginRight ="0%";
      Estraz3.style.marginRight ="0%";
      document.getElementById('retroround').style.visibility= "initial";      
      document.getElementById('youestraz').style.visibility= "initial";
      //document.getElementById('estratte').style.visibility= "initial";
      clearInterval(timer);
 } 
}, 10);                                                                                      
...
// inizio estrazione
      ...
      lx++;
          ...
          avversari();
          if (estr == 0) {
             var pan=document.getElementById("sfondoVerde"); //pan=document.getElementById("panno");
             ...
             if (window.matchMedia("(max-width: 1200px) and (orientation: portrait)").matches){ 
                 ...
                 pan.style.backgroundImage = "url('img/panno-portrait-completa2.png')";
...
function MyBlink() {
  ...
  var nextgame = document.getElementById ( "logos");      
  ...
  switch (gamer) {
    case "youtd" : if (b) {                     
                    ...
                    nextgame.style.border ="6px solid #ffd700"; 
                     }
                    else {
                      ...
                      document.images["plx4"].style.margin="-6px";
                      nextgame.style.border ="6px solid #009500";                       
                    } 
                   break;
    case "lgtd"  : if (b) {                     
   ...
   var x,sm=0;  
    ...
    switch (n){
      case 1 :  //sos = document.getElementById("youestraz").style.content;
                sos = document.getElementById("youestraz").style.visibility;
                str = document.images["youestraz"].src;                
                ind = str.length-5;                               
                //if ((str.charAt(ind) !='d') && (str.charAt(ind)!='k') && (str.charAt(ind)!='') && (sos != 'url("js/img/nullcard.gif")'))  
                if ((str.charAt(ind) !='d') && (str.charAt(ind)!='k') && (str.charAt(ind)!='') && (sos !="hidden"))
                {                                                       
                  let start = Date.now();
                  //alert(start);
                  let timer = setInterval(function() {
                    let timePassed = Date.now() - start;
                  //alert(timePassed);                                                                                                  
                  document.getElementById("youestraz").style.marginRight= `${timePassed / 2}px`;
                  //document.getElementById('estratte').style.visibility= "hidden"; nasconde le wincard estratte
                    if (timePassed > 300) {  
                  ...
                  document.getElementById("YOU").innerHTML = '&alpha;lpha '+sm.toString();              
                }
                break;
      ...
      case 3 :    //sos = document.getElementById("youestraz").style.content;  
                  ...
                  {                     
                    ...
                    let timer = setInterval(function() {
                      let timePassed = Date.now() - start;
                    //alert(timePassed);                    
                      document.getElementById("youestraz").style.marginLeft= `${timePassed / 2}px`;                    
                      if (timePassed > 200) {
...
if (win_ext.includes("dispari")) { 
   ...
   if ((sum<20) && (sum>9)) {        
      if (sum%2 == 1) // non serve conversione, mostra sum su html                          
          document.getElementById("YOU").innerHTML = '&alpha;lpha '+sum.toString(); //sum.toString();                                        
...
// scansiona l'array maz_win per pubblicare le wincard sin qui estratte   
     ...
     /*if (window.matchMedia("(max-width: 1200px)").matches)
     {  // verifico densita' pixel
        if ((window.screen.width)>=(window.innerWidth)) // bassa densità (firefox tablet landscape e tablet tutti portrait)
...
function MyBlink2() {
     if (a) {
        document.images["mazzos"].style.border="6px solid #009500";
         document.images["mazzos"].style.margin="-6px";           
     }
    else {
        
       document.images["mazzos"].style.border="6px solid #ffd700";
       document.images["mazzos"].style.margin="-6px"; 
      } 
  a=!a;
  window.setTimeout("MyBlink2()",1000);
} 

function rotate() {
  
  function isLandscape() { // per i tablet
    return window.innerWidth > window.innerHeight;
   } 
    
// toggle per obbligare a ruotare in portrait  
  function blocco(){
  overlay.style.display = "none";
  overlay.style.background= "rgba(0,0,0,0.9)";
  finestra.style.display = "none";
 ...
 if (window.matchMedia("(max-width: 1200px) and (orientation: landscape)").matches){ // smartphone
    blocco();  
 }
 if (isLandscape()) { // per tablet
   blocco();  
  }  
}
