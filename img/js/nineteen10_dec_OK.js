...
switch (game) {
  case null : //document.getElementById("round").style.content = 'url("img/prima2.jpg")';
             ...
             break;
  case '2'  : document.getElementById("round").style.content = 'url("img/seconda.png")';
              ...
              document.getElementById("estratte").innerHTML = "<br>"+win_estr;
              //alert(win_estr); 
              console.log(maz_win[on]);    
              document.getElementById("mazzos").style.content = 'url('+maz_win[on].img+')'; 
             break;
  case '3'  : document.getElementById("round").style.content = 'url("img/terza.png")';
              document.getElementById('estr_win').style.visibility= "initial"; 
              ...
              document.getElementById("estratte").innerHTML = "<br>"+win_estr;
             break;
  case '4'  : document.getElementById("round").style.content = 'url("img/quarta.png")';
              document.getElementById('estr_win').style.visibility= "initial"; 
          ...
          if (estr == 0) {
            ...
            { 
               if (window.matchMedia("(min-width: 1530px)").matches) 
                    pan.style.backgroundImage = "url('img/panno-verde4-high.png')";
                 else
...
function MyBlink() {
  ...
  switch (gamer) {
    ...
    case "gutd"  : if (b) {                                                   
                        ...
                        //document.images["pl3_1"].style.boxSizing = "border-box";
                        ...
                        //document.getElementById("GU").style.textAlign="right";
                        nextgame.style.border ="6px solid #ffd700";   
                        }
                        else {                                                   
                          //document.getElementById("gutd").style.alignContent="center";
